...
RSpec.describe Tagging, type: :model do
  context 'create' do
    ...
    it 'require tag' do
      record = Record.create! amount: 9999, category: 'income', user: @user
    ...
    it 'has records and tags' do
      ...
      record1 = Record.create! amount: 9999, category: 'income', user: @user
      record2 = Record.create! amount: 9999, category: 'income', user: @user
